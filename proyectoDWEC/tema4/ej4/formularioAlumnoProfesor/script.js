 ...
 * */
function verAsignaturasAlumno() {
    var smr1 = document.getElementById("smr1");
    smr1.style.display = "none";
    var smr2 = document.getElementById("smr2");
    smr2.style.display = "none";
    var daw1 = document.getElementById("daw1");
    daw1.style.display = "none";
    var daw2 = document.getElementById("daw2");
    daw2.style.display = "none";
    if (ciclo.selectedIndex === 1 && curso.selectedIndex === 1) {
    ...
    } else if (ciclo.selectedIndex === 2 && curso.selectedIndex === 2) {
