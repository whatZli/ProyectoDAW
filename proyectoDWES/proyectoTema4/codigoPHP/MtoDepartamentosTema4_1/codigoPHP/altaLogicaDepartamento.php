...
if (isset($_GET['cod'])) {
        ...
        try {
            $sql = "UPDATE `Departamento` SET `FechaBaja` = NULL WHERE `Departamento`.`CodDepartamento` = :codDept;"; //Los : que van delante, es para indicar que sera una consulta preparada
